...
central_dataset = CentralDataset(dataset, sample_num=sample_num_per_cls, num_classes=num_classes, c_type='mode', sigma=sigma)
q = batch_size / len(dataset)

save_dir = "./mode_{}_{}_{}_{}".format(data_name, sample_num_per_cls, sigma, q)
